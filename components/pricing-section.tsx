  ...
  const plans = [
    {
      ...
      monthlyPrice: 65,
      annualPrice: 65 * 12 * 0.9, // 10% descuento anual
      tokens: 10000000,
    ...
    },
    {
      ...
      monthlyPrice: 100,
      annualPrice: 100 * 12 * 0.9, // 10% descuento anual
      tokens: 23000000,
      tokensPerConversation: 40000,
    ...
    },
    {
      ...
      monthlyPrice: 195,
      annualPrice: 195 * 12 * 0.9, // 10% descuento anual
      tokens: 60000000,
      tokensPerConversation: 40000,
        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 max-w-4xl mx-auto mb-8">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Nuestros chatbots utilizan los modelos de IA más avanzados de
              OpenAI (GPT-4), que ofrecen comprensión contextual superior,
              respuestas más naturales y precisas, y capacidades de razonamiento
              avanzadas para brindar la mejor experiencia conversacional a tus
              clientes.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center mb-8">
            <span
              className={`mr-3 ${isAnnual ? "text-gray-500" : "text-gray-900 dark:text-white font-medium"}`}
            >
              Mensual
            </span>
            <Switch
            ...
            />
            <span
              className={`ml-3 ${isAnnual ? "text-gray-900 dark:text-white font-medium" : "text-gray-500"}`}
            >
              Anual{" "}
              <span className="text-primary font-medium">(10% descuento)</span>
            </span>
          </div>
        </div>
